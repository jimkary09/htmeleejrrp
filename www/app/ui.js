define(["d3", "Hexlib"], function (d3, Hexlib) {
    ...
    var hexToPolygon = function (scale, x, y, orientation) {
     ...
     */
    var makeGridDiagram = function (svg, cubes) {
        var diagram = {};
    ...
    var delay = function (element, action) {
    ...
    return {
        ...
        hexToPolygon: hexToPolygon,
        makeGridDiagram: makeGridDiagram
    }
});